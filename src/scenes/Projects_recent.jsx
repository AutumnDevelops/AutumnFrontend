...
const Projects_recent = () => {
  return (
    <section className = "flex flex-col justify-content items-center mx-12 w-[100vw]  md:h-[100vh]" id = "projects_r" style={{ backgroundImage: `url(${background})`, backgroundPosition: "repeat", backgroundSize: "cover"}}>
