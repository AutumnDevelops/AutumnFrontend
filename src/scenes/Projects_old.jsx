...
const Projects_old = () => {
  return (
    <section className = "flex flex-col justify-content items-center my-8 mx-12" >
    <div  className = "flex flex-col justify-content items-center mt-5 w-[300px] text-white p-1 bg-black rounded-lg mb-3 text-2xl"  >
        <h2 style={{ background: "-webkit-linear-gradient(hotpink, pink)", WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent'}}>2024 Projects</h2>
    </div>
